...
// centroids the canvas clearing tests (ADR-R19) and the real road-network boundary nodes the
// generated grid stitches to (ADR-R22, R23). G1 fills it from the build payload; both extras are
